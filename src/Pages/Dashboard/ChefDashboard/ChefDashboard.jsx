...
const ChefDashboard = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50/30 via-white/50 to-red-50/30 dark:from-red-950/20 dark:via-slate-900/80 dark:to-red-950/20 relative overflow-hidden">
      {/* Background Pattern (simplified to avoid unescaped data-URL quotes) */}
      <div className="absolute inset-0 opacity-28 bg-gradient-to-br from-red-50/20 to-transparent"></div>

      {/* Floating Elements (red accents) */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-red-400/8 rounded-full blur-3xl animate-pulse"></div>
        ...
        <main className="flex-1 lg:ml-80 min-h-screen relative">
          ...
          <div className="relative z-10 p-4 lg:p-8 pt-20 lg:pt-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-8 p-6 bg-white/80 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl shadow-xl shadow-red-500/10 border border-white/30 dark:border-slate-700/20 relative overflow-hidden">
                ...
                <div className="absolute -bottom-10 -left-10 w-24 h-24 bg-red-400/8 rounded-full blur-2xl"></div>
